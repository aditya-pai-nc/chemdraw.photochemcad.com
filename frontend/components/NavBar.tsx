...
import { FlaskConical, ChartSpline, ListFilter } from 'lucide-react'

const TABS = [
  { href: '/', label: 'ChemDraw Processor', icon: FlaskConical },
  { href: '/interpolation', label: 'Interpolation', icon: ChartSpline },
  { href: '/bulk-cas', label: 'Bulk CAS Extractor', icon: ListFilter }
]
...
export function NavBar(): JSX.Element {
  ...
  return (
    <nav className="flex items-center gap-1 px-4 py-2.5 border-b border-slate-800 shrink-0 select-none overflow-x-auto whitespace-nowrap">
